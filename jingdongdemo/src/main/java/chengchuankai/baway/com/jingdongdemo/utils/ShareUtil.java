...
public class ShareUtil {
    ...
    public void ShareWeb(int thumb_img, String url, String str, boolean flag) {
        ...
        web.setTitle("1508B");
        new ShareAction(ac).withMedia(web).setPlatform(flag ? SHARE_MEDIA.QQ : SHARE_MEDIA.QZONE).setCallback(shareListener).share();
    }
    ...
    private UMShareListener shareListener = new UMShareListener() {
        ...
        public void onStart(SHARE_MEDIA platform) {
            Toast.makeText(ac, "分享开始", Toast.LENGTH_SHORT).show();
        }
